...
from goals.models import GoalCategory, Goals, GoalComments, Board, BoardParticipant
...
class GoalPermission(IsAuthenticated):
    def has_object_permission(self, request: Request, view: GenericAPIView, obj: Goals) -> bool:
